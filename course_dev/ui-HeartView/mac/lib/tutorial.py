        ...
        self.tutorialLabel = QtWidgets.QLabel(
            'Develop and test pacemaker in real-time! \n\n\
                Here\'s what you need to know...\n\
                    ...
                    - Use the "Natural Heart Characteristics" ccontrol panel to bulid the test routine you want \n\
                    \t(Remember! The test routine wont take affect until you press "DISPATCH TEST")\n\n\
                    - "Active Test Routine" shows the test routine currently running on the heart\n\n\
                    ...
                    - Generate a test report with the PRINT function\n\
                    \tFill out the form that pops up, choose a file destination, and the message will display at the bottom\n\
                    \n\
                Here\'s how to get started...\n\
                    ...
                    8) Start developing! \n\
                    \tAs you begin generating pulses with the pacemaker you will see them in BLUE in each plot'
            )
